...
('click', () => {
    ...
    document.querySelector('.container').style.background='rgb(209, 71, 140)';
});
 ...
 document.querySelector('.x-btn').addEventListener('click', () =>{
        ...
        document.querySelector('.container').style.cssText = ' background: linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.7)), url(images/background2.jpg) center no-repeat; background-size:cover;';
});
